        ...
        <div className="w-full overflow-hidden">
            <div className="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
              <div
                  ...
                  <Button color="bg-white" className="w-full sm:w-auto" onClickEvent={() => Toggle("Create Product")}>New ++</Button>
              </div>
              <CrudModal type="product" show={modal} entity={modalEntity} nameAction={modalAction} close={() => Toggle()}>Create Product</CrudModal>
              <div className="flex flex-col gap-10">
                  <div
                    className="rounded-sm border border-stroke bg-black px-5 pb-2.5 pt-6 shadow-default sm:px-7.5 xl:pb-1">
