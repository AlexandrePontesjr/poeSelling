      ...
      <div className="flex justify-center background-image items-center h-screen">
        <div className="w-96 p-6 shadow-lg bg-black rounded-md">
          <form action="">
            ...
            <div className="mt-3">
              <label htmlFor="username" className="font-pirata text-white">
                Username
              </label>
              <input
                ...
                type="text"
                id="username"
                className="border font-pirata w-full text-base px-2 py-1 focus:outline-none focus:ring-0 focus:border-gray-600"
                placeholder="Enter Username..."
              />
            </div>
            <div className="mt-3">
              <label htmlFor="password" className="font-pirata text-white">
                Password
              </label>
              <input
                ...
                type="password"
                id="password"
                className="font-pirata border w-full text-base px-2 py-1 focus:outline-none focus:ring-0 focus:border-gray-600"
            ...
            <div className="mt-5">
              ...
              <button
                className="font-pirata text-white py-1 w-full rounded-md font-semibold"
                onClick={logIn}
              >
                login
              </button>
