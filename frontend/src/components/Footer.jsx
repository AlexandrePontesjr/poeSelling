...
const Footer = () => (
  ...
  <div className="w-full">
    ...
    <div key={footerlink.title} className={`gap-16  flex ss:my-0 my-4 min-w-[150px]  justify-center py-8`}>
      ...
      <div
          className={`flex font-poppins font-normal text-[16px] leading-[24px] text-dimWhite hover:text-secondary cursor-pointer ${
...
{
  /* <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-6/12`}>
<div className="flex-[1] flex flex-col justify-start mr-10">
  ...
  <p className={`${styles.paragraph} ml-6 mt-4 max-w-[312px]`}>
    A new way to make the payments easy, reliable and secur e.
  </p>
</div>
...
<p className="font-poppins font-normal text-center text-[18px] leading-[27px] text-white">
  Copyright &copy; 2022 TwoBrothers. All Rights Reserved.
</p>

<div className="ml-20 flex flex-row md:mt-0 mt-6">
