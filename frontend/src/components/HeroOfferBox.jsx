    ...
    >
      <div className="relative inline-block group">
        <a href={goto}>
          ...
          />
          <div
            className={` ${game.fontFamily} flex-col font-bold absolute inset-0 flex items-center justify-center bg-opacity-50 text-yellow-500 text-[16px]  sm:text-[36px] transition-opacity duration-300 opacity-100 group-hover:opacity-0`}
          >
          ...
          <div
            className={`${game.fontFamily} flex-col font-bold absolute inset-0 opacity-0 group-hover:opacity-100 flex items-center justify-center bg-opacity-50 text-yellow-500 text-[16px]  sm:text-[36px] transition-opacity duration-300`}
          >
            <span className="mt-8 md:mt-0">{children}</span>
            <div className="gap-1 sm:w-full mt-1 sm:mt-5 ml-4  md:ml-11 flex sm:justify-center sm:gap-10 opacity-100 group-hover:opacity-100">
