...
export default function QATableItem({isLast, entityId, name, answer, openModal}) {

  function deleteClicked() {
    deleteQuestionById(entityId);
    ...
    return (
        <tr>
                        <td
                          className={`${ isLast ? " " : "border-b border-[#eee]" } px-4 py-5 pl-9 xl:pl-11`}
                        >
